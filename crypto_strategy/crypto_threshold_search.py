...
# ============================================================
# Grid Search (sell params, interval buy for training)
# ============================================================

def run_train_grid(df, and_t, or_t, buy_threshold):
...
def grid_search(train_df, buy_threshold):
    ...
    for a in AND_SELL_RANGE:
        for o in OR_SELL_RANGE:
            fv = run_train_grid(train_df, a, o, buy_threshold)
...
def wf_interval_threshold(symbol, buy_threshold):
    ...
    for w in windows:
        ...
        if len(train_df) < 50 or len(test_df) < 10:
            continue
        best, train_ret = grid_search(train_df, buy_threshold)
