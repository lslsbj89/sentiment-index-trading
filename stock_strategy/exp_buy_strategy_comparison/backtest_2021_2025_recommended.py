"""
2021-2025年度回测 - 使用2026推荐参数
=====================================
使用推荐文档中的固定参数对7姐妹股票进行5年回测
"""
...
def main():
    print("=" * 100)
    print("  2021-2025年度回测 - 使用2026推荐参数 (固定参数，非Walk-Forward)")
    print("=" * 100)
    ...
    # 汇总表
    print(f"\n\n{'═'*100}")
    print(f"  2021-2025 五年回测汇总 (使用2026推荐固定参数)")
    print(f"{'═'*100}")
    ...
    print(f"\n  {'股票':<8} {'2022收益':>12} {'评估':>10}")
    print(f"  {'-'*35}")
    for r in results:
        ret_2022 = r['yearly_returns'].get(2022, 0)
        if ret_2022 > -20:
            status = "✓ 良好"
        elif ret_2022 > -40:
            status = "⚠ 一般"
            ...
            status = "✗ 较差"
        print(f"  {r['symbol']:<8} {ret_2022:>+11.1f}% {status:>10}")
